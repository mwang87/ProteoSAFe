...
<head>
	...
	<script src="scripts/result/title.js" language="javascript" type="text/javascript"></script>
	...
	<script src="scripts/result/misc_column_render_widgets_networks.js" language="javascript" type="text/javascript"></script>
	...
	<script src="scripts/result/histogramdisplayer.js" language="javascript" type="text/javascript"></script>
	<script src="scripts/result/scatterplotdisplayer.js" language="javascript" type="text/javascript"></script>
	<script src="scripts/result/parametersdisplayer.js" language="javascript" type="text/javascript"></script>
	<script src="scripts/result/rarefaction_utils.js" language="javascript" type="text/javascript"></script>
	<script src="scripts/result/dummy_download_resultview.js" language="javascript" type="text/javascript"></script>
	...
	<script src="scripts/result/chemical_spectrum_viewer.js" language="javascript" type="text/javascript"></script>
	...
	<script type="text/javascript" src="scripts/result/lorikeet/js/specview_mod.js"></script>
	...
	<script type="text/javascript" src="scripts/result/lorikeet/js/ChemDoodleWeb-libs.js"></script>
    <script type="text/javascript" src="scripts/result/lorikeet/js/ChemDoodleWeb.js"></script>
	...
	/* <![CDATA[ */
		...
		function initDownloadBlock() {
			...
			var url = "<%= request.getContextPath() %>/DownloadResult";
			<%
			boolean first = true;
			for (String parameter : parameters.keySet()) {
				...
				url += encodeURIComponent(
					"<%= StringEscapeUtils.escapeJson(parameter) %>");
				url += "=";
				url += encodeURIComponent(
		...
		<div id="textWrapper">
			<table class="tabform" width="100%" cellspacing="3" cellpadding="1">
				<tr>
					...
					<td width="20%" class="noncell">
						<a href="status.jsp?task=<%= task.getID() %>">
							Back to status page
						</a>
					</td>
					<th width="20%">
						<a href="#"
							onclick="tableManager.collapseAllRows(); return false;">
							Collapse all
						</a>
					</th>
					<th width="20%">
