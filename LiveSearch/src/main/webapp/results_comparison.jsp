...
<%
    String taskid_1 = request.getParameter("taskid1");
    String taskid_2 = request.getParameter("taskid2");
...
<head>
    ...
    <script src="scripts/result_comparison/comparison_rendering.js" language="javascript" type="text/javascript"></script>
    <script src="scripts/result_comparison/spectrum_comparison.js" language="javascript" type="text/javascript"></script>
    <script src="scripts/result_comparison/peptide_comparison.js" language="javascript" type="text/javascript"></script>
    <script src="scripts/result_comparison/protein_comparison.js" language="javascript" type="text/javascript"></script>
    ...
    <script language="javascript" type="text/javascript">
        var task_id1 = "<%= taskid_1 %>";
        var task_id2 = "<%= taskid_2 %>";
		...
		function init() {
			...
			// "Peptide Level Comparison" container
			var comparison_peptide_panel = document.createElement("div");
			comparison_peptide_panel.id = "comparison_peptide_panel";
			comparison_peptide_panel.className = "comparison_content_panel";
			comparison_peptide_panel.style.clear = "both";
			comparison_peptide_panel.style.position = "relative";
			
			// "Protein Level Comparison" container
			var comparison_protein_panel = document.createElement("div");
			comparison_protein_panel.id = "comparison_protein_panel";
			comparison_protein_panel.className = "comparison_content_panel";
			comparison_protein_panel.style.clear = "both";
			comparison_protein_panel.style.position = "relative";
			
			// add import boxes to the "Results Selection" div
			render_import_boxes("left_input", "right_input",
				container_div, comparison_panel, comparison_peptide_panel,
				comparison_protein_panel)
			
			// add all container divs
			$("#maindisplay").append(container_div);
			$("#maindisplay").append(comparison_panel);
			$("#maindisplay").append(comparison_peptide_panel);
			$("#maindisplay").append(comparison_protein_panel);
        }
