...
public class WorkflowWorker extends GridWorker {
	public String getFlowName() {
		return flow;
	}

	private String flow;
	private Logger logger = LoggerFactory.getLogger(WorkflowWorker.class);

	public WorkflowWorker(File policyFolder) {
		super(policyFolder);
		flow = null;
